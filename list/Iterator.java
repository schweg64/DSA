package list;
/** An Iterator allows the client to step through a Collection, such
 * as a List, and selectively remove values.
...
public interface Iterator<E> {
	...
	/**
	 * @return true iff there are at least two more values to
	 * be obtained
	 */
	boolean has2More();
	...
	/** Remove the last value obtained by a call to
	  ...
	  * Pre:  The next() method has been called at 
	  * least once since the last call to remove() or remove2()
	  */
	void remove2();
}
